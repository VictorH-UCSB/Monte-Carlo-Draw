...
*
insheet using "gr2019_pell_ssl_data_stata.csv", comma clear
label data "dct_gr2019_pell_ssl"
...
label define label_psgrtype 1 "Total 2013 cohort (Bachelor^s and other degree/certificate seeking) - four-year institutions "
label define label_psgrtype 2 "Bachelor^s degree seeking 2013 cohort - four-year institutions ",add
label define label_psgrtype 3 "Other degree/certificate seeking 2013 cohort - four-year institutions ",add
label define label_psgrtype 4 "Degree/certificate seeking 2016 cohort (less than four-year institutions)",add
