...
*
insheet using "gr2019_data_stata.csv", comma clear
label data "dct_gr2019"
...
label define label_section 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2013 subcohort (4-yr institution)"
label define label_section 2 "Bachelor^s or equiv 2013 subcohort (4-yr institution)",add
label define label_section 3 "Other degree/certif-seeking 2013 subcohort (4-yr institution)",add
label define label_section 4 "Degree/certif-seeking students 2016 cohort ( 2-yr )",add
label values section label_section
label define label_cohort 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2013 subcohorts (4-yr institution)"
label define label_cohort 2 "Bachelor^s or equiv 2013  subcohort (4-yr institution)",add
label define label_cohort 3 "Other degree/certif-seeking 2013 subcohort (4-yr institution)",add
label define label_cohort 4 "Degree/certif-seeking students 2016 cohort ( 2-yr institution)",add
