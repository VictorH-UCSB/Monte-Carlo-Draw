...
**pop_gen.R** defines the function: `pop_gen`. It takes a vector generated in **set_para.R** and `N`, a numeric input representing the popultion size. The function outputs a vector of length `N` with each element following iid Normal distribution, specified by the input parameter.  
